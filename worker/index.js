// Custom service worker for Push Notifications (Pusher Beams)
// Original author: Pusher
// Original code: https://js.pusher.com/beams/service-worker.js
        ...
        (function () {
            var _ref2 = asyncToGenerator(
                ...
                regenerator.mark(function _callee2(payloadFromCallback) {
                    var hideNotificationIfSiteHasFocus, title, body, icon, image, badge, tag, lang, options;
                        ...
                        while (1) {
                            switch ((_context2.prev = _context2.next)) {
                                ...
                                case 8:
                                    ...
                                    image = payloadFromCallback.notification.image;
                                    badge = payloadFromCallback.notification.badge;
                                    tag = payloadFromCallback.data.tag;
                                    lang = payloadFromCallback.data.lang;
...
PusherPushNotifications.onNotificationReceived = ({ pushEvent, payload, handleNotification }) => {
    ...
    payload.notification.icon = "/icon-512x512.png";
    payload.notification.image = "/icon-512x512.png";
    payload.notification.badge = "/icon-512x512.png";
